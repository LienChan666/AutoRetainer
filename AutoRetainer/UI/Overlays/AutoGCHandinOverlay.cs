...
internal unsafe class AutoGCHandinOverlay : Window
{
    ...
    public AutoGCHandinOverlay() : base("AutoRetainer GC Handin overlay".Loc(), ImGuiWindowFlags.NoDecoration | ImGuiWindowFlags.AlwaysUseWindowPadding | ImGuiWindowFlags.AlwaysAutoResize | ImGuiWindowFlags.NoFocusOnAppearing | ImGuiWindowFlags.NoSavedSettings, true)
    {
    ...
    public override void Draw()
    {
        ...
        {
            ImGui.SameLine();
            ImGuiEx.Text(ImGuiColors.DalamudViolet, string.Format("{0} items left".Loc(), Remaining));
        }
